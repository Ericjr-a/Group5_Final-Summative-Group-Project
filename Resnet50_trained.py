...
# Training the model
# we initially run the training of the model with 500 epochs and achieved a val_accuracy of 0.63
# further attempts to retrain the model caused us to run out of time to get a higher accuracy. 
# each epoch takes 4 - 5 minutes to complete during training
# we resulted to training our own model for deployment
history = model.fit(
